...
const ProductDetails = () => {
  ...
  <Container>
    <div className='card' style={{width: 'auto', height: '100%', boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.2)', borderRadius: '10px',padding:'20px'}}>
...
>
  Submit
        ...
        {isSubmitted && <p style={{color:"green",fontSize:'20px'}}>Thank you for your review!</p>}
