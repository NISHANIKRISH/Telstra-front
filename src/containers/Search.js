...
const SearchProducts = () => {
  const [searchQuery, setSearchQuery] = useState('');// eslint-disable-next-line
  ...
  return (
    <div>
      ...
      <form>
        ...
        <input type="textarea" value={searchQuery} onChange={handleInputChange} class="form-control me-1" style={{ marginTop: '20px',borderRadius:'30px',alignContent:'centre',width:'400px',height:'60px',marginLeft:'492px' }}  placeholder="Type here" aria-label="submit"/>
